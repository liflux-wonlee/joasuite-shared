...
export const Route = createFileRoute("/app/suite/settings")({
  component: SuiteSettingsHub,
});
...
function SuiteSettingsHub() {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-6xl mx-auto space-y-8">
      ...
      <Section title={t("suite.section.org", "Organization")} tiles={orgTiles} />
      <Section title={t("suite.section.apps", "Apps")} tiles={appsTiles} />
      <Section
